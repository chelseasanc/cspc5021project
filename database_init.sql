...
CREATE TABLE APPLICANT(
  ...
  US_CITIZEN VARCHAR(10) NOT NULL,
  NATIVE_LANGUAGE VARCHAR(10) NOT NULL,
  GENDER VARCHAR(10) NOT NULL,
  HISP_LATINO VARCHAR(10) NOT NULL
) ENGINE=InnoDB;
...
CREATE TABLE APPLICATION(
  ...
  ACADEMIC_PROBATION VARCHAR(10) NOT NULL,
  ...
  FINANCIAL_AID VARCHAR(10) NOT NULL,
  EMP_TUITION_ASSISTANCE VARCHAR(10) NOT NULL,
  OTHER_PROGRAMS VARCHAR(10) NOT NULL,
  FELON_MISDEMEAN VARCHAR(10) NOT NULL
) ENGINE=InnoDB;
...
CREATE TABLE EMPLOYMENT_HISTORY(
  ...
  FTE_STATUS VARCHAR(10) NOT NULL
) ENGINE=InnoDB;
